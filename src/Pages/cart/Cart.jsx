  ...
  // Delete Cart from Localstorage
    ...
    const [phoneNumber, setPhoneNumber] = useState("")
     ...
     const buyNow =async () => {
      ...
      // Create an object and store in firebase
      const addressInfo = {
        name,
        address,
        pincode,
      ...
      // Payment integration
      var options = {
        key: "rzp_test_fxqbH9sC4I7eZ7",
        key_secret: "yqn6FiUAF4Llr7XpminZvtiv",
             ...
             return(
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                <div className="mt-5 sm:mt-0">
                  ...
                  <h2 className="text-sm  text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>{description}c</h2>
